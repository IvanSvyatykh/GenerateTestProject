...
async def get_area_keyboard() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="📚 Языки и литература", callback_data="area_languages"
                )
            ],
            [
                InlineKeyboardButton(
                    text="🔢 Математика и информатика", callback_data="area_math"
                )
            ],
            [
                InlineKeyboardButton(
                    text="🌍 Общественные науки", callback_data="area_social"
                )
            ],
            [
                InlineKeyboardButton(
                    text="🔬 Естественные науки", callback_data="area_science"
                )
            ],
            [
                InlineKeyboardButton(
                    text="🎨 Искусство и культура", callback_data="area_art"
                )
            ],
            [InlineKeyboardButton(text="🛠️ Технология", callback_data="area_tech")],
            [
                InlineKeyboardButton(
                    text="🧠 Личностное развитие", callback_data="area_personal"
                )
            ],
            [
                InlineKeyboardButton(
                    text="✍🏻 Ввести предметную область вручную",
                    callback_data="manual_area",
                )
            ],
        ]
    )
